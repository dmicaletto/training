...
window.workoutDays = {
	'day_1': {
		...
		exercises: [
			{ name: "Panca Piana - Bilanciere", sets: 4, reps: "12-10-10-8", rest: "90s", defaultWeight: 40, imageUrl: './images/panca-piana.gif?text=PANCA+PIANA', notes: "Mantieni le spalle basse e concentratevi solo sulla contrazione del petto." },
			{ name: "Panca 30° Multypower", sets: 3, reps: "10", rest: "90s", defaultWeight: 40, imageUrl: './images/panca-multypower.gif?text=PANCA+INCLINATA+MULTYPOWER?text=FRENCH+PRESS', notes: "Movimento controllato, senti l'allungamento. Usa un peso moderato." },
			...
			{ name: "Chest Press distensioni delle braccia", sets: 3, reps: "10", rest: "90s", defaultWeight: 25, imageUrl: './images/Chest-Press-Machine.gif?text=CHEST+PRESS', notes: "Spingi i gomiti in avanti. Contrai il petto al massimo accorciamento." },
			...
			{ name: "Spinte in Basso (Pushdown)", sets: 3, reps: "12", rest: "60s", defaultWeight: 15, imageUrl: './images/pushdown.png?text=TRICIPITI+PUSH', notes: "Porta il cavo fino in fondo. Contrai il tricipite alla massima estensione." },
			{ name: "French Press (Manubri) panca 30°", sets: 3, reps: "12 (x braccio)", rest: "90s", defaultWeight: 12, imageUrl: './images/french-press.png?text=PECTORAL+FLY?text=FRENCH+PRESS', notes: "Movimento controllato, senti l'allungamento. Usa un peso moderato." },
			{ name: "Lombari Iperestensioni", sets: 3, reps: "12", rest: "60s", defaultWeight: 40, imageUrl: './images/hyperextension.gif?text=HYPEREXTENSION', notes: "Esegui lentamente con controllo. Non forzare l'estensione." },
	...
	'day_2': {
		...
		exercises: [
			{ name: "Calf Raises on leg press", sets: 4, reps: "10", rest: "90s", defaultWeight: 40, imageUrl: './images/Calf-Press-on-Leg-Press-Machine.gif?text=CALF+RAISES+LEG+PRESS', notes: "Spingi con le punte." },
			...
			{ name: "Lento avanti panca 70°", sets: 3, reps: "10 (x braccio)", rest: "90s", defaultWeight: 14, imageUrl: './images/lento-manubri.gif?text=LENTO+MANUBRI', notes: "Siediti in modo da isolare solo gli adduttori. Controlla il ritorno." },
	...
	'day_3': {
		...
		exercises: [
			{ name: "Rematore Manubri", sets: 4, reps: "8-10 (x braccio)", rest: "90s", defaultWeight: 18, imageUrl: './images/rematore-manubrio.gif?text=REMATORE+MANUBRIO', notes: "Tira con i gomiti, non con i bicipiti. Schiena dritta." },
			...
			{ name: "Pulley basso con Triangolo", sets: 3, reps: "10-12", rest: "60s", defaultWeight: 30, imageUrl: './images/pulley-basso.png?text=REMATORE', notes: "Petto in fuori, schiena inarcata. Porta il triangolo all'ombelico." },
	...
	'day_4': {
		...
		exercises: [
			{ name: "panca piana manubri", sets: 3, reps: "10-12 (x braccio)", rest: "90s", defaultWeight: 16, imageUrl: './images/Chest-Press-con-Manubri-gif.gif?text=CHEST+MANUBRI', notes: "Non bloccare le ginocchia in alto. Spingi con i talloni." },
			{ name: "Chest Press distensioni delle braccia", sets: 3, reps: "8-12", rest: "90s", defaultWeight: 25, imageUrl: './images/chestpress.png?text=CHEST+PRESS', notes: "Spingi i gomiti in avanti. Contrai il petto al massimo accorciamento." },
			{ name: "panca inclinata manubri", sets: 3, reps: "10-12 (x braccio)", rest: "90s", defaultWeight: 16, imageUrl: './images/spinte-panca-alta-manubri.png?text=SPINTE+PANCA+ALTA', notes: "Focus sui femorali. Movimento lento in fase negativa." },
			{ name: "Alzate Laterali", sets: 3, reps: "10 (x braccio)", rest: "60s", defaultWeight: 12, imageUrl: './images/alzate-laterali.png?text=ALZATE+LATERALI', notes: "Gomiti leggermente flessi. Porta i manubri all'altezza delle spalle, non più su." },
			{ name: "Alzate Frontali", sets: 3, reps: "10 (x braccio)", rest: "60s", defaultWeight: 10, imageUrl: './images/alzate-frontali.png?text=ALZATE+FRONTALI', notes: "Solleva alternando le braccia o entrambe insieme. Movimento controllato." },
			{ name: "Alzate Posteriori su panca", sets: 3, reps: "10 (x braccio)", rest: "60s", defaultWeight: 10, imageUrl: './images/inverso-manubri-panca-alta-bg.png?text=ALZATE+POSTERIORI', notes: "Solleva alternando le braccia o entrambe insieme. Movimento controllato." },
			{ name: "Lombari Iperestensioni", sets: 3, reps: "12", rest: "60s", defaultWeight: 10, imageUrl: './images/hyperextension.gif?text=HYPEREXTENSION', notes: "Esegui lentamente con controllo. Non forzare l'estensione." },
			{ name: "Abdoninal Crunch", sets: 4, reps: "15", rest: "60s", defaultWeight: 20, imageUrl: './images/ABS_CRUNCH_MC.gif?text=CRUNCH', notes: "Concentrati sull'avvicinare lo sterno al bacino, non sul collo." },
		]
